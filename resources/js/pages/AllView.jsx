...
const AllView = () => {
    ...
    return (
       <>
        <h1 className='text-black flex justify-center font-semibold text-lg'>人気の映画</h1>
        <div className=' grid lg:grid-cols-5 md:grid-cols-3 mb-10'>
         <PopularMovieLists notify={ notify } />
        </div >
        <div className='mt-10'>

        <h1 className='text-black flex justify-center font-semibold text-lg'>公開予定の映画</h1>
        </div>
