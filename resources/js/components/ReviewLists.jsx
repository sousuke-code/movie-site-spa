...
const ReviewLists = ({ id }) => {
  ...
  return (
    ...
    <a href="#" class="block p-6 white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full m-2">
